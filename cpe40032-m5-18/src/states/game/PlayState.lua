...
function PlayState:render()
    ...
    if self.player.win then
        ...
        love.graphics.setColor(0, 0, 0, 255)
        love.graphics.printf('GREAT WORK!', 1, VIRTUAL_HEIGHT / 2 - 40 + 1, VIRTUAL_WIDTH, 'center')
        love.graphics.setColor(255, 255, 255, 255)
        love.graphics.printf('GREAT WORK!', 0, VIRTUAL_HEIGHT / 2 - 40, VIRTUAL_WIDTH, 'center')
    end
end
